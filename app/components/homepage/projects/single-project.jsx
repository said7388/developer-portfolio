...
const SingleProject = ({ project }) => {
  ...
  return (
    <div className='singleProject w-full h-fit flex flex-col items-center justify-center relative cursor-text overflow-hidden px-8 py-[1.4rem] bg-[linear-gradient(90deg,#281e57_0%,#201435_100%)] shadow-2xl rounded-lg border border-[#1a1443]'
    >
      ...
      <div className='projectContent flex flex-col items-center justify-between w-full h-full'>
        ...
        <div className="p-6">
          <Image
            ...
            width={1080}
            height={720}
            className='w-80 h-64 transition-opacity duration-[0.7s] delay-[0.3s] cover-image rounded-lg'
          />
        </div>
      ...
      <p className='project--desc absolute w-[80%] min-h-[150px] translate-x-[-110%] translate-y-[50%] transition-transform duration-[0.9s] p-6 leading-[110%] rounded-[0_20px_20px_0] left-0 top-0 bg-[#0f0b24]  text-[#EFF3F4]'>
        {description}
      </p>
