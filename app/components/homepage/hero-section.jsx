      ...
      <div className="grid grid-cols-1 items-start lg:grid-cols-2 lg:gap-12 gap-y-8">
        <div className="order-2 lg:order-1 flex flex-col items-start justify-center p-2 pb-20 md:pb-10 lg:pt-10">
          ...
          <div className="my-12 flex items-center gap-5">
            <Link className="transition-all text-pink-500 hover:scale-125 duration-300" href='/'>
              <BsGithub size={30} />
            </Link>
            <Link className="transition-all text-pink-500  hover:scale-125 duration-300" href='/'>
              <BsLinkedin size={30} />
          ...
          <div className="flex items-center gap-3">
            <Link href="/courses" className="bg-gradient-to-r to-pink-500 from-violet-600 p-[1px] rounded-full transition-all duration-300 hover:from-pink-500 hover:to-violet-600">
              <button className="px-3 text-xs md:px-8 py-3 bg-[#0d1224] rounded-full border-none text-center md:text-sm font-medium uppercase tracking-wider text-[#ffff] no-underline transition-all duration-200 ease-out  md:font-semibold flex items-center gap-1 hover:gap-3">
                <span>Contact me</span>
                <RiContactsFill size={16} />
              </button>
            </Link>

            <Link className="flex items-center gap-1 hover:gap-3 rounded-full bg-gradient-to-r from-pink-500 to-violet-600 px-3 md:px-8 py-3 text-center text-xs md:text-sm font-medium uppercase tracking-wider text-white no-underline transition-all duration-200 ease-out hover:text-white hover:no-underline md:font-semibold" role="button" href="/courses"
            >
        ...
        <div className="order-1 lg:order-2 from-[#0d1224] border-[#1b2c68a0] relative rounded-lg border bg-gradient-to-r to-[#0a0d37]">
          ...
          <div className="overflow-hidden border-t-[2px] border-indigo-900 px-8 py-8">
            <code className="font-mono text-xs md:text-sm lg:text-base">
              ...
              <div><span className="ml-16 mr-2 text-gray-400">{`);`}</span></div>
